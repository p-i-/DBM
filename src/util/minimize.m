...
%
% Ensure f is the name-STRING of a function of this form:
%
%    [f_of_X, gradient] = f( X, P1, P2, P3, P4, P5 )
%
% starting at:
%    X -- [D,1] vector where D is #params in network
%
% using:
%    length > 0  % maximum number of line searches
%    length < 0  % |length| gives maximum allowed number of function evaluations
%
% Returns: 
%    X -- minimum
